 ...
 * Xử lý tất cả các thao tác cơ sở dữ liệu và logic nghiệp vụ liên quan đến đăng ký gói dịch vụ
 */
class SubscriptionRepository extends BaseRepository
{
    ...
    /**
     * Xử lý việc mua gói đăng ký mới sử dụng Stripe
     * @param int $planId ID của gói dịch vụ được mua
     * @return array Phản hồi chứa dữ liệu đăng ký hoặc dữ liệu phiên Stripe
     */
    ...
    /**
     * Tạo và cấu hình phiên thanh toán Stripe
     * @param Plan $subscriptionPlan Gói dịch vụ được mua
     * @param array $data Chứa số tiền và ID đăng ký
     * @return array ID phiên Stripe đã tạo
     */
    ...
    /**
     * Xử lý logic cốt lõi của đăng ký bao gồm:
     * - Xác thực gói dịch vụ
     * - Quản lý thời gian dùng thử
     * - Tính toán chia tỷ lệ khi chuyển đổi gói
     * - Tạo bản ghi đăng ký
     * 
     * @param int $planId ID của gói dịch vụ đang đăng ký
     * @return array Chi tiết đăng ký và số tiền thanh toán
     */
...
//            $frequencyDays = $planFrequency == Plan::MONTHLY ? 30 : 365;
    ...
    /**
     * Cập nhật trạng thái đăng ký sau khi thanh toán thành công
     * - Kích hoạt đăng ký mới
     * - Vô hiệu hóa các đăng ký khác
     * - Tạo bản ghi giao dịch
     * 
     * @param Request $request Chứa ID phiên Stripe
     * @return Subscription Đăng ký đã được kích hoạt
     */
    ...
    /**
     * Xử lý quy trình đăng ký thanh toán thủ công
     * Tương tự như manageSubscription nhưng bao gồm:
     * - Xử lý ghi chú
     * - Xử lý tệp đính kèm
     * 
     * @param int $planId ID gói dịch vụ
     * @param array $data Chứa ghi chú và tệp đính kèm
     * @return array Chi tiết đăng ký
     */
...
//            $frequencyDays = $planFrequency == Plan::MONTHLY ? 30 : 365;
    ...
    /**
     * Lấy tệp đính kèm của đăng ký để tải xuống
     * @param Subscription $subscription
     * @return array [nội dung tệp, headers]
     */
    ...
    /**
     * Xử lý dọn dẹp khi thanh toán thất bại
     * @param int $planId ID của đăng ký thất bại
     * @return bool
     */
