...
/**
 * Class PostRepository - Quản lý các thao tác CRUD và xử lý logic cho model Post để đăng bài
 */
class PostRepository extends BaseRepository
{
     ...
     * 2. Xử lý tags
     * 3. Xử lý trạng thái bài viết (draft/active)
     * 4. Xử lý các thuộc tính visibility, featured, breaking, slider...
     * 5. Lưu thông tin cơ bản của bài viết
     * 6. Upload và lưu các file media (ảnh, file đính kèm)
     * 7. Lưu thông tin chi tiết theo loại bài viết (article, gallery, video...)
     ...
     * @return bool
     * 
     * Quy trình tương tự như hàm store(), nhưng:
     * - Tìm và cập nhật bài viết hiện có thay vì tạo mới
     * - Xóa media cũ trước khi thêm media mới
     * - Cập nhật thông tin chi tiết theo loại bài viết
     */
    ...
    /**
     * Lưu bài viết dạng audio
     * 
     * @param array $input Dữ liệu audio
     * @param Post $post Bài viết liên quan
     * @return bool
     */
    ...
    /**
     * Lưu bài viết dạng article
     * Bao gồm nội dung bài viết dạng text/html
     */
