        ...
        <div class="card">
            ...
            <div class="card-body">
                        ...
                        <div class="mb-3" io-image-input="true">
                            <div class="d-block">
                                <div class="image-picker">
                                    @php
                                        $style = 'style="background-image: url('.(($setting['logo'])?asset($setting['logo']):asset('assets/image/k22-logo.png')).')"';
                                    @endphp
                ...
                <div class="row">
                    ...
                    @php
                        $style2= 'style="background-image: url('.(($setting['favicon'])?asset($setting['favicon']):asset('assets/image/k22-logo.png')).')"';
                    @endphp
                    <div class="col-lg-8">
                        <div class="mb-3" io-image-input="true">
                            <div class="d-block">
    ...
    <div class="container-fluid mt-5">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-4">
                        {{ Form::label('show_captcha',__('Show Captcha On Registration').':',
                                     ['class'=>'form-label fs-6']) }}
                    </div>
                    <div class="col-lg-8">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active"
                                   name="show_captcha_on_registration" id="showCaptchaOnRegistration"
                ...
                <div class="row mt-5 mb-5 captchaOptions {{$setting['show_captcha'] || $setting['show_captcha_on_registration'] ? '' : 'd-none'}}">
                    <div class="col-lg-4">
                ...
                <div class="row mb-5 captchaOptions {{$setting['show_captcha'] || $setting['show_captcha_on_registration'] ? '' : 'd-none'}}">
                    <div class="col-lg-4">
    ...
    <div class="container-fluid mt-5">
        <div class="card">
            ...
            <div class="card-body pt-0">
                <div class="row mt-5">
                    <div class="col-lg-4">
                        {{ Form::label('show_captcha',__('messages.setting.whatsapp').':',
                                     ['class'=>'form-label fs-6']) }}
                    </div>
                    <div class="col-lg-8">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active"
                                   ...
                                   type="checkbox" value="1"
                                    {{$setting['whatsapp'] ? 'checked' : ''}} >
                        </div>
                    </div>
                </div>
                <div class="row mt-5">
                    <div class="col-lg-4">
                        {{ Form::label('show_captcha',__('messages.setting.linkedIn').':',
                                     ['class'=>'form-label fs-6']) }}
                    </div>
                    <div class="col-lg-8">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active"
                                   ...
                                   type="checkbox" value="1"
                                    {{$setting['linkedin'] ? 'checked' : ''}} >
                        </div>
                    </div>
                </div>
                <div class="row mt-5">
                    <div class="col-lg-4">
                        {{ Form::label('show_captcha',__('messages.setting.twitter').':',
                                     ['class'=>'form-label fs-6']) }}
                    </div>
                    <div class="col-lg-8">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active"
                                   ...
                                   type="checkbox" value="1"
                                    {{$setting['twitter'] ? 'checked' : ''}} >
                        </div>
                    </div>
                </div>
                <div class="row mt-5">
                    <div class="col-lg-4">
                        {{ Form::label('show_captcha',__('messages.setting.facebook').':',
                                     ['class'=>'form-label fs-6']) }}
                    </div>
                    <div class="col-lg-8">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input w-30px h-20px is-active"
                                   ...
                                   type="checkbox" value="1"
                                    {{$setting['facebook'] ? 'checked' : ''}} >
                        </div>
                    </div>
                </div>
                <div class="row mt-5">
                    <div class="col-lg-4">
                        {{ Form::label('show_captcha',__('messages.setting.reddit').':',
                                     ['class'=>'form-label fs-6']) }}
                    </div>
                    <div class="col-lg-8">
                        <div class="form-check form-switch form-check-custom form-check-solid">
